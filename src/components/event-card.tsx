...
const MositionLink = motion(Link);
...
export default function EventCard({ event }: EventCardProps) {
  ...
  return (
    ...
    >
      <section
        className="w-full h-full flex flex-col flex-1  basis-80  
    max-w-[500px] bg-white/[3%] rounded-xl overflow-hidden relative state-effects"
      >
        <Image
          src={event.imageUrl}
          alt={event.name}
